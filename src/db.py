...
def initialize_database(config: dict[str, Any], root: Path) -> Path:
    ...
    with sqlite3.connect(db_path) as connection:
        ...
        _add_column_if_missing(connection, "trades", "section", "TEXT")
        _add_column_if_missing(connection, "trades", "market_section", "TEXT")
        _add_column_if_missing(connection, "trades", "listing_market", "TEXT")
        ...
        _add_column_if_missing(connection, "scoring_results", "section", "TEXT")
        _add_column_if_missing(connection, "scoring_results", "market_section", "TEXT")
        _add_column_if_missing(connection, "scoring_results", "listing_market", "TEXT")
