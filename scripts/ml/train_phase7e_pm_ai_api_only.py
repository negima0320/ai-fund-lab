...
from ml.phase7e_pm_ai_api_only_trainer import Phase7EPMAIAPIOnlyTrainerPrototype, TrainOptions  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run PM AI API-only trainer prototype.")
    ...
    parser.add_argument("--train-full", action="store_true", help="Train on the full Phase 7-D dataset.")
